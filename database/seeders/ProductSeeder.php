...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            [
                'name'=>'Plan Blazer Vest Pants',
                "price"=>"6250",
                "description"=>"Fit Type: Relaxed | [Feature]: Men's 3 Pieces Tux Blazer Suit, Notch Lapel 2 Buttons Blazer Jacket with Flap Pockets; 5 Buttons Single Breasted V-Neck Vest & Elastic Band Casual Trousers | [Multi Occasion]: This 3 piece herringbone business suit set provides an easy choice for many occasions, like daily life, business, meeting,formal work, wedding, parties, dating, banquet, graduation ceremony, performance and so on. It will shows men’s charm and gentle well",
                "category"=>"trending",
                "gallery"=>"https://pluspng.com/img-png/handsome-man-png-hd-suit-png-image-920.png"
            ]
        ]);
    }
}
